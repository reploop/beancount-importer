    ...
    private static final String mapping = """
            {
                ...
                "expenses": {
                        ...
                        "万物云空间科技服务股份有限公司": "Expenses:RealEstate",
                        ...
                        "三亚市人民医院": "Expenses:HealthCare",
                        "北京大学第三医院": "Expenses:HealthCare",
                        "信德诺医疗器械销售部": "Expenses:HealthCare",
                        "叮当快药": "Expenses:HealthCare",
                        "北京市海淀医院": "Expenses:HealthCare",
                        "北京市医院管理中心": "Expenses:HealthCare",
                        "北京康旭医学检验所有限公司": "Expenses:HealthCare",
                        "医院": "Expenses:HealthCare",
                        "微保": "Expenses:HealthCare",
                        "新冠状检测": "Expenses:HealthCare",
                        ...
                        "北京市朝阳区交通运行管理中心": "Expenses:CarCare",
                        "北京市海淀区城市管理委员会": "Expenses:CarCare",
                        "北京市交管局": "Expenses:CarCare",
                        ...
                        "购百特": "Expenses:LifeServices",
                        "转账红包": "Expenses:MoneyTransfer",
                        "酒店旅游": "Expenses:HotelTravel",
                        "神州优车(福建)信息技术有限公司": "Expenses:HotelTravel",
                        "平凉广成大酒店": "Expenses:HotelTravel",
                        "北京市香山公园管理处": "Expenses:HotelTravel",
                        "天时同城": "Expenses:HotelTravel",
                        "临春岭": "Expenses:HotelTravel",
                        "云港科技": "Expenses:HotelTravel",
                        "电动游览车售票处": "Expenses:HotelTravel",
                        ...
                        "西贝": "Expenses:FoodBeverage",
                        "撒拉花儿": "Expenses:FoodBeverage",
                        "川渝小厨": "Expenses:FoodBeverage",
                        ...
                        "主食厨房北京知春里弯巷店": "Expenses:FoodBeverage",
                        "主食厨房北京双榆树店": "Expenses:FoodBeverage",
                        "果仕多社区生鲜": "Expenses:FoodBeverage",
                        ...
                        "话事酒馆": "Expenses:FoodBeverage",
                        "汉唐小馆": "Expenses:FoodBeverage",
                        "蓝蛙餐饮": "Expenses:FoodBeverage",
                        "老碗会陕西手工面": "Expenses:FoodBeverage",
                        "喜乐手打柠檬茶": "Expenses:FoodBeverage",
                        "黔溪里鲜牛肉米线": "Expenses:FoodBeverage",
                        "美团/大众点评点餐订单": "Expenses:FoodBeverage:Takeaway",
                        "美团外卖App": "Expenses:FoodBeverage:Takeaway",
                        ...
                        "老张牛肉面": "Expenses:FoodBeverage",
                        "牛奶": "Expenses:FoodBeverage",
                        "米粉": "Expenses:FoodBeverage",
                        "和番丼饭": "Expenses:FoodBeverage",
                        "麦当劳": "Expenses:FoodBeverage",
                        "深圳和府餐饮管理有限公司": "Expenses:FoodBeverage",
                        "拉面": "Expenses:FoodBeverage",
                        "兰州拉面": "Expenses:FoodBeverage",
                        "南城香": "Expenses:FoodBeverage",
                        "海鲜牛肉火锅": "Expenses:FoodBeverage",
                        "桌边付": "Expenses:FoodBeverage",
                        "嘉和一品": "Expenses:FoodBeverage",
                        "日本料理": "Expenses:FoodBeverage",
                        "农科味道食堂": "Expenses:FoodBeverage",
                        "职工食堂": "Expenses:FoodBeverage",
                        "遇见小面": "Expenses:FoodBeverage",
                        ...
                        "云南过桥米线": "Expenses:FoodBeverage",
                        "渔语鱼": "Expenses:FoodBeverage",
                        "KOI": "Expenses:FoodBeverage",
                        "老太太拌饭": "Expenses:FoodBeverage",
                        "壹零捌道": "Expenses:FoodBeverage",
                        "外婆家": "Expenses:FoodBeverage",
                        "北京壹零捌道餐厅": "Expenses:FoodBeverage",
                        "遇见小面订单支付": "Expenses:FoodBeverage",
                        "肉串汪自由派": "Expenses:FoodBeverage",
                        "武圣羊汤": "Expenses:FoodBeverage",
                        "三亚吉阳曾记胖哥麻辣面馆": "Expenses:FoodBeverage",
                        "夏与寻土家鲜肉饼": "Expenses:FoodBeverage",
                        "1006567萨迈私房牛肉面": "Expenses:FoodBeverage",
                        "郭记味霸板面牛杂面": "Expenses:FoodBeverage",
                        "天顺祥号餐饮店": "Expenses:FoodBeverage",
                        "西部马华": "Expenses:FoodBeverage",
                        "海底捞火锅": "Expenses:FoodBeverage",
                        "三亚麦金地餐厅": "Expenses:FoodBeverage",
                        "喜家德": "Expenses:FoodBeverage",
                        "禾盛兴旺餐饮集团": "Expenses:FoodBeverage",
                        "晋来顺手擀面": "Expenses:FoodBeverage",
                        "北京西麦郎云涛餐饮管理有限公司": "Expenses:FoodBeverage",
                        "北京牛濎鸿兰州牛肉面": "Expenses:FoodBeverage",
                        "北京市京麦龙牛肉面": "Expenses:FoodBeverage",
                        "西少爷": "Expenses:FoodBeverage",
                        "和合谷": "Expenses:FoodBeverage",
                        ...
                        "好邻居四店": "Expenses:DailyNecessities",
                        "天天易家(北京)信息科技有限公司": "Expenses:DailyNecessities",
                        "一手好牌": "Expenses:DailyNecessities",
                        "知春东里超市蔬菜": "Expenses:DailyNecessities",
                        "炎炎水果": "Expenses:DailyNecessities",
                        "北京超市发连锁股份有限公司": "Expenses:DailyNecessities",
                        "先购后付": "Expenses:DailyNecessities",
                        "轻巧拿": "Expenses:DailyNecessities",
                        "优剪": "Expenses:DailyNecessities",
                        "便利蜂": "Expenses:DailyNecessities",
                        "全家爱超市": "Expenses:DailyNecessities",
                        "三亚百益超市中环店": "Expenses:DailyNecessities",
                        "佳园春便民果蔬超市": "Expenses:DailyNecessities",
                        "知春里蔬菜水果店": "Expenses:DailyNecessities",
                        "超市发双榆树店": "Expenses:DailyNecessities",
                        "熊本便利店": "Expenses:DailyNecessities",
                        "7-11(SEB)": "Expenses:DailyNecessities",
                        "扫二维码付款": "Expenses:DailyNecessities",
                        "24H便利购": "Expenses:DailyNecessities",
                        ...
                        "转账备注:微信转账": "Expenses:Other",
                        "光辉岁月": "Expenses:Other",
                        "微信小店": "Expenses:Other",
                        "商户_兰万平": "Expenses:Other",
                        "京东": "Expenses:Other",
                        "AllenLiu": "Expenses:Other",
                        "张玉荣": "Expenses:OutdoorSports",
                        "水": "Expenses:OutdoorSports",
                        "天眼查官方版": "Expenses:BusinessService",
                        "柏溪(北京)科技有限公司": "Expenses:BusinessService",
                        "发出群红包": "Expenses:RedPacket:WeChat",
                        "微信红包": "Expenses:RedPacket:WeChat"
                },
                "income": {
                ...
                "liabilities": {
                    ...
                    "浦发银行信用卡(3879)":"Liabilities:CreditCard:SPD:3879",
                    "浦发银行(0083)":"Liabilities:CreditCard:SPD:0083"
                }
            }
            """;
